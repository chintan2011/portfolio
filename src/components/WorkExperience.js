...
function WorkExperience(display) {
    console.log("Display from WorkExperience=>" + JSON.stringify(display))
    return (
        <div hidden={display.display} className="workExperienceContainer">
            <Alert.Heading>
                Work Experience
            </Alert.Heading>
